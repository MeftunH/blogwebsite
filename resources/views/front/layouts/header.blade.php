...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="{{route('homepage')}}">
          @if($config->logo!=null)
          <img src="{{asset($config->logo)}}" width="100" class="rounded-circle" /></a>
      @else
      {{$config->title}}
      @endif
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          @endforeach
          <li class="nav-item">
            <a class="nav-link" href="{{route('contact.post')}}">Contact</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('@yield('bg',asset('front/img/home-bg.jpg'))')">    <div class="overlay"></div>
    <div class="container">
      <div class="row">
